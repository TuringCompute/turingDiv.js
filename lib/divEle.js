...
class DivEle{
    ...
    setChild(childId, childObj){
        ...
        if(this.children.data.hasOwnProperty(childId) && this.children.data[childId].node){
            this.children.data[childId].node.destroy()
        }
    ...
    markChildDeleted(childId){
        if(this.children.data.hasOwnProperty(childId)){
            if(this.children.data[childId].node){
